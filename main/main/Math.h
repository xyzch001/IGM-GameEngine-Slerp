...
namespace Math
{
	...
	struct Quaternion
	{
		...
		/// <returns>A reference to this quaternion.</returns>
		const Quaternion& Set(Math::Vector3& Axis, f32 Angle);
		...
		__declspec(deprecated("This is broken!!!"))
			const Quaternion& Set(Math::Vector3& Angles);
		...
		/// <returns>A reference to this quaternion.</returns>
		__declspec(deprecated("This is broken!!!"))
			const Quaternion& Set(f32 RotationX, f32 RotationY, f32 RotationZ)
		{
#pragma warning( push )
